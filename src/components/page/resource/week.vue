<template>
    <div>
        ...
        <div class="container">
             ...
             <div class="card-area">
                <div class="row-text">周榜奖励 <i-Switch size="large">
...
开启后在小程序-个人中心显示“榜单奖励”按钮，点击按钮显示宣传页
             ...
             <div class="card-area">
                <div>
                    ...
                    <div class="tips">小程序开屏和首页轮播在第1名产生后自动生成，后援金和户外大屏线下发放
</div>
                </div>
                <div class="tag-area">
         ...
         <div class="card-area">
            <div class="row-text tag-text">宣传页
            </div>
            <div>图片格式必须为：png,bmp,jpeg,jpg,gif；不可大于2M
